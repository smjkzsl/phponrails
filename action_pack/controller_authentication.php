...
class AkControllerAuthentication
{
    ...
    public function authenticateOrRequestWithHttpBasic($realm = APP_NAME, $login_procedure) {
    ...
    public function requestHttpBasicAuthentication($realm = APP_NAME) {
        return $this->_authenticationRequest($realm);
    }

    public function authenticateOrRequestWithHttpDigest($realm = APP_NAME, $login_procedure) {
    ...
    public function requestHttpDigestAuthentication($realm = APP_NAME) {
