...
defined('SINTAGS_REMOVE_PHP_SILENTLY')           || define('SINTAGS_REMOVE_PHP_SILENTLY', false);
defined('SINTAGS_REPLACE_SHORTHAND_PHP_TAGS')    || define('SINTAGS_REPLACE_SHORTHAND_PHP_TAGS', true);
defined('SINTAGS_HIDDEN_COMMENTS_TAG')           || define('SINTAGS_HIDDEN_COMMENTS_TAG', 'hidden');
defined('SINTAGS_OPEN_HELPER_TAG')               || define('SINTAGS_OPEN_HELPER_TAG', '<%');
defined('SINTAGS_CLOSE_HELPER_TAG')              || define('SINTAGS_CLOSE_HELPER_TAG', '%>');
defined('SINTAGS_HASH_KEY_VALUE_DELIMITER')      || define('SINTAGS_HASH_KEY_VALUE_DELIMITER', '=>');


/**
 * Sintags is Rails default template language. The initial goal when
 ...
 * 
 * h3. Examples using the helpers registered by the [[http://www.rails.org/|PhpOnRails Framework]]
 * 
 ...
 * PHP
 * 
 *     <?php echo $controller->url_helper->link_to($controller->text_helper->translate("Visit Other Site"), "http://www.rails.org/", array('confirm' => "Are you sure?")); ?>
 * 
 * More translations.
 * 
 * Sintags
 ...
 * PHP
 * 
 *     <?php echo $controller->url_helper->link_to("Visit Other Site", "http://www.rails.org/", array('confirm' => "Are you sure?")); ?>
 * 
 ...
 * Sintags
 * 
 *     <%= link_to "Visit Other Site", "http://www.rails.org/", :confirm => "Are you sure?", :options => ["Yes", 'No'] %>
 * 
 * PHP
 * 
 *     <?php echo $controller->url_helper->link_to("Visit Other Site", "http://www.rails.org/", array('confirm' => "Are you sure?", 'options' => array("Yes", 'No'))); ?>
 * 
