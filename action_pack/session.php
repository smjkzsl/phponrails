...
* </code>
*
* @author Bermi Ferrer <bermi at rails com>
...
class AkSession
{
    ...
    public function init($options = array(),$type = null) {
        ...
        switch ($type) {
            ...
            case 2:
                ...
                $AkDbSession->session_life = SESSION_EXPIRE;
    ...
    */
    public function _read($id) {
        $result = $this->_driverInstance->get($id,'SESSIONS');
    ...
    */
    public function _write($id, $data) {
        ...
        if($this->_original_sess_value != $data){
            $ret = $this->_driverInstance->save($data, $id,'SESSIONS');
            if(!$ret){
                return false;
            }else{
                return true;
    ...
    */
    public function _destroy($id) {
        return (bool)$this->_driverInstance->remove($id,'SESSIONS');
    }
    ...
    */
    public function _gc() {
        return (bool)$this->_driverInstance->clean('SESSIONS','old');
    }
}
