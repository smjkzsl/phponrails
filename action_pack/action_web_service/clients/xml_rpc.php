...
require_once(CONTRIB_DIR.DS.'incutio'.DS.'IXR_Library.inc.php');
...
class AkXmlRpcClient extends IXR_Client
{
    ...
    public function init() {
        ...
        'user_agent' => 'Rails XML-RPC Client',
        'build' => true,
         ...
         */
         'cache_remote_methods' => isset($_SESSION) && ACTION_WEBSERVICE_CACHE_REMOTE_METHODS
         );
