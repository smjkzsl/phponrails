...
class AkBaseModel extends AkLazyObject
{
    ...
    */
    ...
    public function setParentModelName($model_name = null) {
        if(!empty($model_name)){
            ...
            if($class_name == 'AkActiveRecord'){
                trigger_error(Ak::t('The PhpOnRails Framework could not automatically configure your model name.'.
                ...
                ' in your model constructor in order to make this work.',array('%path'=>MODELS_DIR.DS)), E_USER_ERROR);
                return false;
            }
    ...
    public function t($string, $array = null, $controller=null) {
        ...
        return Ak::t($string, $array,$controller ? $controller : AkInflector::underscore($this->getModelName()));
    }
    ...
    protected function _enableObservers() {
        ...
        'autoload_path' => ACTIVE_SUPPORT_DIR.DS.'models'.DS.'observer.php'
        ));
    }
    ...
    protected function _enableErrors() {
        ...
        'autoload_path' => ACTIVE_SUPPORT_DIR.DS.'models'.DS.'errors.php'
        ));
    }
    ...
    protected function _enableValidations() {
        ...
        'autoload_path' => ACTIVE_SUPPORT_DIR.DS.'models'.DS.'validations.php'
        ));
    }
    ...
    protected function _enableUtilities() {
        ...
        'autoload_path' => ACTIVE_SUPPORT_DIR.DS.'models'.DS.'utilities.php'
        ));
    }
    protected function _enableDebug() {
        ...
        'autoload_path' => ACTIVE_SUPPORT_DIR.DS.'models'.DS.'debug.php'
        ));
    }
