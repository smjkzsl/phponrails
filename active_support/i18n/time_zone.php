...
class AkTimeZone
{
    ...
    */
    public function adjust($time) {
        return $time + $this->utc_offset + ($this->dst && $this->inDst($time, $this->name) ? 3600 : 0) - UTC_OFFSET;
    }
...
if(!defined('UTC_OFFSET')){
    ...
    if(!defined('UTC_OFFSET')){
        ...
        $_AkCurrentZone = $_AkCurrentZone->create(DEFAULT_TIMEZONE);
        define('UTC_OFFSET', $_AkCurrentZone->utc_offset);
