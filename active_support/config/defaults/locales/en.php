...
$dictionary=array (
  ...
  'The PhpOnRails Framework could not automatically configure your model name. This might be caused because your model file is not located on %path. Please call $this->setModelName("YourModelName"); in your model constructor in order to make this work.' => 'The PhpOnRails Framework could not automatically configure your model name. This might be caused because your model file is not located on %path. Please call $this->setModelName("YourModelName"); in your model constructor in order to make this work.',
  'Unable to fetch current model name' => 'Unable to fetch current model name',
  'Unable to set "%table_name" table for the model "%model".  There is no "%table_name" available into current database layout. Set ACTIVE_CONTROLLER_VALIDATE_TABLE_NAMES constant to false in order to avoid table name validation' => 'Unable to set "%table_name" table for the model "%model".  There is no "%table_name" available into current database layout. Set ACTIVE_CONTROLLER_VALIDATE_TABLE_NAMES constant to false in order to avoid table name validation',
