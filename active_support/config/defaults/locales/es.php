...
$dictionary=array (
  ...
  'The PhpOnRails Framework could not automatically configure your model name. This might be caused because your model file is not located on %path. Please call $this->setModelName("YourModelName"); in your model constructor in order to make this work.' => 'El PhpOnRails Framework no ha podido configurar automáticamente el nombre del modelo. Esto puede deberse a que el modelo no se ha podido hayar en %path. Si lo desea puede utilizar $this->setModelName("MiModelo"); en el constructor para asignar un nombre manualmente.',
  'Unable to fetch current model name' => 'No se ha podido averiguar el nombre del modelo actual',
  'Unable to set "%table_name" table for the model "%model".  There is no "%table_name" available into current database layout. Set ACTIVE_CONTROLLER_VALIDATE_TABLE_NAMES constant to false in order to avoid table name validation' => 'No se ha podido relacionar la tabla "%table_name" con el modelo "%model". No se ha encontrado ninguna tabla llamada "%table_name" entre las tablas de la base de datos. Defina la constante ACTIVE_CONTROLLER_VALIDATE_TABLE_NAMES como falsa en config/config.php para desactivar la auto-averiguación de los nombres de tablas',
  'You are calling recursively AkActiveRecord::setAttribute by placing parent::setAttribute() or  parent::set() on your model "%method" method. In order to avoid this, set the 3rd paramenter of parent::setAttribute to FALSE. If this was the behaviour you expected, please define the constant ACTIVE_RECORD_PROTECT_SET_RECURSION and set it to false' => 'You are calling recursivelly AkActiveRecord::setAttribute by placing parent::setAttribute() or  parent::set() on your model "%method" method. In order to avoid this, set the 3rd paramenter of parent::setAttribute to FALSE. If this was the behaviour you expected, please define the constant ACTIVE_RECORD_PROTECT_SET_RECURSION and set it to false',
  'You are calling recursively AkActiveRecord::getAttribute by placing parent::getAttribute() or  parent::get() on your model "%method" method. In order to avoid this, set the 3rd paramenter of parent::getAttribute to FALSE. If this was the behaviour you expected, please define the constant ACTIVE_RECORD_PROTECT_GET_RECURSION and set it to false' => 'You are calling recursivelly AkActiveRecord::getAttribute by placing parent::getAttribute() or  parent::get() on your model "%method" method. In order to avoid this, set the 3rd paramenter of parent::getAttribute to FALSE. If this was the behaviour you expected, please define the constant ACTIVE_RECORD_PROTECT_GET_RECURSION and set it to false',
  'Error' => 'Error',
  ...
  'Unable to set "%table_name" table for the model "%model".  There is no "%table_name" available into current database layout. Set ACTIVE_RECORD_VALIDATE_TABLE_NAMES constant to false in order to avoid table name validation' => 'Unable to set "%table_name" table for the model "%model".  There is no "%table_name" available into current database layout. Set ACTIVE_RECORD_VALIDATE_TABLE_NAMES constant to false in order to avoid table name validation',
  ...
  'Could not set %column_name as the inheritance column as this column type is "%column_type" instead of "string".' => 'Could not set %column_name as the inheritance column as this column type is "%column_type" instead of "string".',
  'Could not set "%column_name" as the inheritance column as this column is not available on the database.' => 'Could not set "%column_name" as the inheritance column as this column is not available on the database.',
  'The PhpOnRails Framework could not automatically configure your model name. This might be caused because your model file is not located on %path. Please call $this->setParentModelName("YourParentModelName"); in your model constructor in order to make this work.' => 'The PhpOnRails Framework could not automatically configure your model name. This might be caused because your model file is not located on %path. Please call $this->setParentModelName("YourParentModelName"); in your model constructor in order to make this work.',
  ...
  'In order to disable XHTML validation, set the <b>ENABLE_STRICT_XHTML_VALIDATION</b> constant to false on your config/development.php file' => 'In order to disable XHTML validation, set the <b>ENABLE_STRICT_XHTML_VALIDATION</b> constant to false on your config/development.php file',
  'Tag &lt;code&gt;%tag&lt;/code&gt; must occur inside another tag' => 'Tag &lt;code&gt;%tag&lt;/code&gt; must occur inside another tag',
  'Tag &lt;code&gt;%tag&lt;/code&gt; is not allowed within tag &lt;code&gt;%previous&lt;/code&gt;' => 'Tag &lt;code&gt;%tag&lt;/code&gt; is not allowed within tag &lt;code&gt;%previous&lt;/code&gt;',
  '%previous tag is not a content tag. close it like this \'&lt;%previous /&gt;\'' => '%previous tag is not a content tag. close it like this \'&lt;%previous /&gt;\'',
