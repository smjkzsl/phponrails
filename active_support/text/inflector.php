...
class AkInflector
{
    ...
    */
    ...
    static function _inflect($word, $new_value, $type, $dictionary = null) {
        Ak::deprecateWarning('AkInflector::_inflect is deprecated and will be removed in future Rails versions. Please use AkInflector::inflect() instead.');
    ...
    static function _loadConfig($dictionary) {
        Ak::deprecateWarning('AkInflector::_loadConfig is deprecated and will be removed in future Rails versions. Please use AkInflector::loadConfig() instead.');
