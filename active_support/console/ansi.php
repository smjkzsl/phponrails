...
defined('AVOID_ANSI_CONSOLE_COLORS') || define('AVOID_ANSI_CONSOLE_COLORS', false);
...
class AkAnsiColor
{
     ...
     * 
     * It can also be disabled by defining AVOID_ANSI_CONSOLE_COLORS to true.
     * 
    ...
    {
        return !(AVOID_ANSI_CONSOLE_COLORS || (AkConfig::getOption('avoid_ansi_console_colors', false)) || !(WIN ? !getenv('ANSICON') : true));
    }
}