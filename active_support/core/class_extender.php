 ...
 * 
 * The AkClassExtender provides the means for extending core PhpOnRails Framework
...
class AkClassExtender
{
    ...
    function _canIncludeMergedFile($class_name_to_extend, $checksum) {
        $merge_path = TMP_DIR.DS.'.lib';
        if(CLASS_EXTENDER_ENABLE_CACHE && file_exists($merge_path.DS.'Extensible'.$class_name_to_extend.'.php') &&
