...
{
<?php 
    if($model_name != $controller_name){ // if equal will be handled by the Rails directly
        echo "    var \$models = '$singular_name';\n\n";
    }
?>
    function index() {
        $this->redirectToAction('listing',array('page'=>@$this->params['page']));
    }
...
<?php  endforeach; ?>
	...
	try{
		...
		$this->flash['notice'] = $this->t('<?php echo $model_name?> was not found any things ,please add.');
