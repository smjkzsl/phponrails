...
class RailsDashboardHelper extends AkBaseHelper {
    ...
    public function get_twitter_feeds($screen_name = 'rails'){
    ...
    public function format_snippet($code = '', $snippet_type = ''){
        ...
        $snippet_corner_image = $this->_controller->ak_url_helper->url_for(array('action' => "images", 'controller' => 'virtual_assets', 'module' => 'rails_panel', 'id' => "$snippet_type-box-corner", 'format' => "gif"));
