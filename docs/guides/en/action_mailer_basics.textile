...
<shell>
./mrails generate mailer UserMailer
exists  app/models/
...
Had we wanted to send text-only emails, the file would have been called +welcome_email.text.plain.tpl+. Rails sets the content type of the email to be the one in the filename.
...
So how does Action Mailer understand this +deliver_welcome_email+ call? If you read the documentation (http://api.rails.org/files/vendor/rails/actionmailer/README.html), you will find this in the "Sending Emails" section:
