...
* You can build the Guides during testing by running +./mrails guides+ in the +railties+ directory.
...
"Rails: Documentation":http://groups.google.com/group/rails-docs is the mailing list for all the guides/documentation related discussions.
