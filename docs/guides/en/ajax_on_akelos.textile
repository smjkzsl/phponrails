...
As we said, the purpose of RJS is to write PHP which is then auto-magically turned into JavaScript by Rails. The above example didn't look too PHP-esque so let's see how to do it the Rails way:
