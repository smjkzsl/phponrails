...
class Mailer_TestCase extends ActionMailerUnitTest
{
    ...
    public function test_mime_header_to_utf() {
        ...
        'X-Rails-Random: =?ISO-8859-11?B?4L7U6MG7w9DK1Le41MDSvuPL6aHRuuCr1MPsv+DHzcPstOnHwiBEdWFsLUNvcmUgSW50ZWwoUikgWGVvbihSKSBQcm9jZXNzb3Ig48vB6A==?='=>'X-Rails-Random: �?��ิ่มประสิทธิภาพให้กับ�?��ิร์ฟ�?��อร์ด้ว�?Dual-Core Intel(R) Xeon(R) Processor ใหม่',
        'X-Rails-Random: =?UTF-8?B?0KDRg9GB0YHQutC40Lkg5Lit5paHINei15HXqNeZ16o=?='=>'X-Rails-Random: Русский 中文 עברית',
        'X-Rails-Random: =?UTF-8?B?ZXN0w6Egw6MgYsOkc8OqNjQ=?='=>'X-Rails-Random: está ã bäsê64',
        //'X-Rails-Random: =?ISO-2022-JP?B?GyRCJDMkcyRLJEEkT0AkMyYbKEI=?='=>'X-Rails-Random: こんにちは世�?,

        'X-Rails-Random: =?UTF-8?Q?E=C3=B1e_de_Espa=C3=B1a?= =?UTF-8?Q?_Fwd:_?= =?UTF-8?Q?=E3=81=93=E3=82=93=E3=81=AB=E3=81=A1=E3=81=AF=E4=B8=96=E7=95=8C?='=>'X-Rails-Random: Eñe de España Fwd: こんにちは世�?,
