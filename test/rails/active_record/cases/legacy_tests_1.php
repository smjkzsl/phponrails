...
class LegacyTests1_TestCase extends ActiveRecordUnitTest
{
    ...
    public function test_should_get_rails_database_type() {
        $AkTestField = new AkTestField();
        ...
        $this->assertEqual('binary',$AkTestField->getRailsDataType($adodb_column_object));

        $adodb_column_object->type = 'integer';
        $adodb_column_object->auto_increment = 1;
        $this->assertEqual('serial',$AkTestField->getRailsDataType($adodb_column_object));

        $AkTestField->decimalFieldDataType = 'string';
        $this->assertEqual('string',$AkTestField->getRailsDataType($adodb_column_object));
    }
    ...
    public function test_should_get_table_name() {
        ...
        $this->assertUpcomingError('ACTIVE_RECORD_VALIDATE_TABLE_NAMES');
