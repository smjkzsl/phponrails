...
class Validations_TestCase extends ActiveRecordUnitTest
{
    ...
    public function Test_of_validatesFormatOf() {
        $Person = new TestPerson();
        $Person->validatesFormatOf('email', EMAIL_REGULAR_EXPRESSION);
        ...
        $Person->clearErrors();
        $Person->first_name = '';
        $Person->validatesFormatOf('first_name', NOT_EMPTY_REGULAR_EXPRESSION,"can not be empty");
        ...
        $Person->clearErrors();
        $Person->number = 12.56;
        $Person->validatesFormatOf('number', NUMBER_REGULAR_EXPRESSION);
        ...
        $Person->clearErrors();
        $Person->phone = 'blah';
        $Person->validatesFormatOf('phone', PHONE_REGULAR_EXPRESSION);
        ...
        $Person->clearErrors();
        $Person->date = 'Monday';
        $Person->validatesFormatOf('date', DATE_REGULAR_EXPRESSION);
        ...
        $Person->clearErrors();
        $Person->ip = '257.0.0.1';
        $Person->validatesFormatOf('ip', IP4_REGULAR_EXPRESSION);
        ...
        $Person->clearErrors();
        $Person->post_code = 'a';
        $Person->validatesFormatOf('post_code', POST_CODE_REGULAR_EXPRESSION);
