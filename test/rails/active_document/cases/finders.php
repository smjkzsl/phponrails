...
class DocumentFinders_TestCase extends ActiveDocumentUnitTest
{
    ...
    public function test_should_find_by_attributes() {
        $attributes = array('title' => 'Rails.org', 'author' => 'Bermi');
        ...
        $this->assertTrue($FoundRails = $this->WebPage->findFirst(array('conditions'=>array('title'=>'Rails.org'))));
        $this->assertEqual($FoundRails->getId(), $Rails->getId());
        ...
        $this->assertEqual($Pages[0]->getId(), $Rails->getId());
