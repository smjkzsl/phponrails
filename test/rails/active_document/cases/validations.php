...
class DocumentValidations_TestCase extends ActiveDocumentUnitTest
{
    ...
    public function test_should_validate_format() {
        $D = $this->ValidDocument;;
        $D->validatesFormatOf('email', EMAIL_REGULAR_EXPRESSION);
        ...
        $D->clearErrors();
        $D->first_name = '';
        $D->validatesFormatOf('first_name', NOT_EMPTY_REGULAR_EXPRESSION,"can not be empty");
        ...
        $D->clearErrors();
        $D->number = 12.56;
        $D->validatesFormatOf('number', NUMBER_REGULAR_EXPRESSION);
        ...
        $D->clearErrors();
        $D->phone = 'blah';
        $D->validatesFormatOf('phone', PHONE_REGULAR_EXPRESSION);
        ...
        $D->clearErrors();
        $D->date = 'Monday';
        $D->validatesFormatOf('date', DATE_REGULAR_EXPRESSION);
        ...
        $D->clearErrors();
        $D->ip = '257.0.0.1';
        $D->validatesFormatOf('ip', IP4_REGULAR_EXPRESSION);
        ...
        $D->clearErrors();
        $D->post_code = 'a';
        $D->validatesFormatOf('post_code', POST_CODE_REGULAR_EXPRESSION);
