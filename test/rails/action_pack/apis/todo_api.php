...
class TodoApi extends AkActionWebserviceApi
{
    public function __construct() {
        ...
        'expects'=> array('struct' => 'A struct like: array("name" => "Rails integration tasks", "description" => "This list should be completed in less than one week", "private" => true)'),
        ...
        'expects'=> array('int' => 'List Id', 'struct' => 'A struct like: array("name" => "Rails integration tasks", "description" => "This list should be completed in less than one week", "private" => true)'),
