...
class FormHelper_TestCase extends HelperUnitTest
{
    ...
    public function test_value_before_type_cast()
    {
        ...
        $this->active_record->name_before_type_cast = 'test_rails';
        $this->assertEqual($this->ak_form_helper_instance_tag->value_before_type_cast(), 'test_rails');
    }
