...
class AssetTagHelper_TestCase extends HelperUnitTest
{
    public function setUp()
    {
        ...
        $this->controller->asset_host = ASSET_HOST;
    ...
    public function test_javascript_include_tag()
    {
        ...
        $this->asset_tag_helper->register_javascript_include_default('rails_fx');
        $new_defaults = $this->asset_tag_helper->_get_javascript_included_defaults();
        $new_defaults_count = count($new_defaults);
        $this->assertEqual('rails_fx',array_pop($new_defaults));
    ...
    public function test_image_tag()
    {
        ...
        $this->assertEqual(
        $this->asset_tag_helper->image_tag('summer_in_toronto.jpg',array('alt' => 'rails alt')),
        '<img alt="rails alt" src="'.$this->testing_url_path.'/images/summer_in_toronto.jpg" />'
        );
        $this->assertEqual(
    ...
    public function test_stylesheet_for_current_controller()
    {
        ...
        $controller->asset_host = ASSET_HOST;
