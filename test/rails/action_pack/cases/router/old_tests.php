...
class OldRouter_TestCase extends RouterUnitTest
{
    ...
    public function setUp() {
        ...
        $this->url_prefix = URL_REWRITE_ENABLED ? '' : '/?ak=';
    ...
    public function testToParams() {
        ...
        $input_value = '/redirect/'.urlencode('http://www.rails.com/buscar_dominio');
        $expected = array('controller'=>'redirect','url'=>'http://www.rails.com/buscar_dominio');
        $this->assertEqual($this->Router->match($this->createRequest($input_value)),$expected);
    ...
    public function testToUrl() {
        ...
        $expected = URL_REWRITE_ENABLED ? '/blog/view/newest?format=printer_friendly' : '/?ak=/blog/view/newest/&format=printer_friendly';
        $this->assertEqual((string)$this->Router->urlize($input_value),$expected);
...
class Router_Conflicts_TestCase extends RouterUnitTest
{
    ...
    public function test_should_allow_variables_with_slashes() {
        $params = array('controller'=>'page','action'=>'redirect', 'value'=>'http://rails.org/download/');
        $url = '/page/redirect/http%3A%2F%2Frails.org%2Fdownload%2F';
        $this->assertEqual((string)$this->Router->urlize($params), $url);
