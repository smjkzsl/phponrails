...
class LocaleManager_TestCase extends ActionPackUnitTest
{
    ...
    public function test_should_get_browser_language() {
        $_SERVER['HTTP_ACCEPT_LANGUAGE'] = $this->LocaleManager->_browser_language = 'zh-cn,en-us,en,es-es;q=0.5;';

        $this->LocaleManager->available_locales = array('zh_cn'=>'cn','en_us'=>'en_us','en'=>'en','es_es'=>'es_es');
    ...
    public function test_should_get_language_from_url() {
        ...
        $Request->ak = 'cn';
        $Request->_request['ak'] = 'cn';
        $this->LocaleManager->available_locales = array('cn'=>array('cn'),'es_es'=>array('es_es','spain'));
    ...
    public function test_locale_setting_getting_deleting_methods() {
        !defined('TEST_TRANSLATIONS') ? define('TEST_TRANSLATIONS',true):null;
        ...
        $dictionary = AkLocaleManager::getDictionary(FRAMEWORK_LANGUAGE,$namespace);
        ...
        $this->assertTrue(AkLocaleManager::deleteDictionary(FRAMEWORK_LANGUAGE,$namespace));
        $this->assertEqual(array(),AkLocaleManager::getDictionary(FRAMEWORK_LANGUAGE,$namespace));
    ...
    public function test_framework_config_locale_update() {
        ...
        $locale_files = AkLocaleManager::updateLocaleFiles();
        list($locales,$core_dictionary) = AkLocaleManager::getCoreDictionary(FRAMEWORK_LANGUAGE);
