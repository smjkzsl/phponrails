...
class PluginManager_TestCase extends ActiveSupportUnitTest
{
    public function __construct() {
        parent::__construct();
        $this->offline_mode = !(@file_get_contents('http://svn.rails.org/plugins'));
    }
    ...
    public function test_should_get_available_repositories() {
        ...
        $this->assertTrue(in_array('http://svn.rails.org/plugins', $repositories));
    }
    ...
    public function test_should_get_remote_plugin_list() {
        ...
        $this->assertEqual($plugins['acts_as_versioned'], 'http://svn.rails.org/plugins');
    }
