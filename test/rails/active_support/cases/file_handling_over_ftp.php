...
//
// In order to pass these tests you'll neet to have an ftp server configured at ftptesting.rails.org

if(!defined('UPLOAD_FILES_USING_FTP')){
    if(!function_exists('ftp_connect')){
        echo "PHP is not compiled with FTP support\n";
        return;
    }
    define('RUN_FTP_TESTS', true);
    define('UPLOAD_FILES_USING_FTP', true);
    define('READ_FILES_USING_FTP', true);
    define('DELETE_FILES_USING_FTP', true);
    define('FTP_PATH', 'ftp://tests:tests@ftptesting.rails.org');
    define('FTP_AUTO_DISCONNECT', true);
}else{
