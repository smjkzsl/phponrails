...
class Conversions_TestCase extends ActiveSupportUnitTest
{
    public function test_html_to_text() {
        $html = <<<EOF
<h1 id="creating_a_simple_application_using_the_rails_framework">Creating a simple application using the PhpOnRails Framework</h1>

<h2 id="introduction">Introduction</h2>

<p>This tutorial teaches you how to create an application using the PhpOnRails Framework. </p>
...
<p>You can checkout a working copy of the Rails source code with the command:</p>

<pre><code>svn co http://railsframework.googlecode.com/svn/trunk/ rails
</code></pre>
EOF;
        $markdown = <<<EOF
Creating a simple application using the PhpOnRails Framework
========================================================
...
You can checkout a working copy of the Rails source code with the command:
    ...
    svn co http://railsframework.googlecode.com/svn/trunk/ rails
EOF;
