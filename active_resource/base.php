...
/**
* AkActiveResource is the main class for mapping RESTful resources as models in a Rails application.
* 
* For an outline of what Active Resource is capable of, see active_resource/README.markdown
* 
* == Automated mapping
* 
* Active Resource objects represent your RESTful resources as manipulatable Rails objects.  To map resources
