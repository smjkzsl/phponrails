...
defined('MONGO_DEFAULT_HOST')        || define('MONGO_DEFAULT_HOST', 'localhost');
defined('MONGO_DEFAULT_DATABASE')    || define('MONGO_DEFAULT_DATABASE', AkInflector::underscore(APP_NAME));
