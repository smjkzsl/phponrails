...
If you want to set up a 1â€? relationship between two models, you'll need to add +belongs_to+ to one, and +has_one+ to the other. How do you know which is which?
