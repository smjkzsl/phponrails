...
To start playing with testing you'll want to ensure that +ACTION_CONTROLLER_PERFORM_CACHING+ is set to +true+ if you're running in development mode. This flag is normally set in the corresponding +config/environments/*.php+ and caching is disabled by default for development and test, and enabled for production.

<php>
define('ACTION_CONTROLLER_PERFORM_CACHING', true);
</php>
