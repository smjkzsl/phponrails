Comment créer une application simple grâce au framework Rails
=========================================================
...
Pour faire fonctionner vos applications, Rails utilise le [motif de conception appelé MVC](http://fr.wikipedia.org/wiki/Motif_de_conception).
