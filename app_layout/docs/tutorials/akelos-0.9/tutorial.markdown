...
You have downloaded Rails and made sure you'll be able to run PHP scripts from your console (not necessary to run Rails, but it's required for this tutorial)
