...
defined('ACTION_MAILER_LEGAL_HEADER') ||
define('ACTION_MAILER_LEGAL_ATTRIBUTE_SETTERS', 
...
class AkMailComposer
{
    ...
    protected $_legal_attribute_setters = ACTION_MAILER_LEGAL_ATTRIBUTE_SETTERS;
    ...
    public function getRawMessage($MessageOrPart = null, $force_overload = false) {
        ...
        if($force_overload || empty($Message->raw_message)){
            ...
            ACTION_MAILER_EOL.ACTION_MAILER_EOL.
            $raw_body;
        }
    ...
    public function getRawHeadersAndBody($MessageOrPart = null) {
        ...
        if(is_array($raw_body_or_parts)){
            ...
            $raw_body .= ACTION_MAILER_EOL.'--'.$this->getBoundary().'--'.ACTION_MAILER_EOL;
