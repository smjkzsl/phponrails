...
class AkActiveRecordLocalization extends AkActiveRecordExtenssion
{
    ...
    public function getAvailableLocales() {
        ...
        if(empty($available_locales)){
            if(defined('ACTIVE_RECORD_DEFAULT_LOCALES')){
                $available_locales = Ak::stringToArray(ACTIVE_RECORD_DEFAULT_LOCALES);
            }else{
    ...
    public function setInternationalizedAttribute($attribute, $value, $inspect_for_callback_child_method = ACTIVE_RECORD_ENABLE_CALLBACK_SETTERS, $compose_after_set = true) {
        if(is_array($value)){
